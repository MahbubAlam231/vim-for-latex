# ~/.bash_aliases — Custom alias definitions
...
alias   vpht='vp -d leetcode/hash-table-leetcode -f'
alias    vpf='vp -d finanal -f'
alias   vpda='vp -d coursera/ data analysis with python -f'
alias   vpdl='vp -d deep learning ai andrew ng -f'
...
alias   cind='commit_industry_files'
alias   cweb='commit_web'
alias     cw='commit_web'
alias     ca='commit_all'
alias      h='happy'
